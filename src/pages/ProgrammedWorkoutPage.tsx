...
import { SingleWorkoutComponent } from "../components/programmedWorkouts/SingleWorkoutComponent";
...
export const ProgrammedWorkoutPage = (
    <Route path={PROGRAMMED_WORKOUT_ROUTE} element={<RequireAuth><Outlet /></RequireAuth>}>
        ...
        <Route path={`:${PROGRAMMED_WORKOUT_ID_PARAM}`} element={<SingleWorkoutComponent />} />
    </Route>
);
