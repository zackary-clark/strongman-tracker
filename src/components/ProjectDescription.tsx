    ...
    return (
        <Box margin={isSmallScreen ? 1 : 4}>
            ...
            <Typography variant="body1" mt={4} mx={4}>
                To try out the app, login with the email <Typography
                variant="button"
                color="secondary"
            >demo@demo.com</Typography> and password <Typography variant="button" color="secondary">demo</Typography>.
            </Typography>
            ...
            <Box margin={4}>
                <Typography variant="body1">
                    Mostly as a learning exercise. But I do <i>actually</i> think a niche exists in the workout
                    tracking &quot;market&quot;
                ...
                <List dense>
                    ...
                    <ListItem>
                        <ListItemIcon><ChevronRight /></ListItemIcon>
                        <ListItemText>Changing rep/set schemes each week (for example when peaking for a
                                      meet)</ListItemText>
                    </ListItem>
                </List>
                <Typography variant="body1">
                    At my current pace, I&apos;ll implement those features by the year 3022 at the earliest, but this is
                    really just to learn
                    and keep my skills sharp during periods where I cannot be &quot;hands on keyboard&quot; as much as
                    I&apos;d like at work.
                </Typography>
            </Box>
        </Box>
